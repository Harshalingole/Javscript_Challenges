...
export function cookingStatus(params) {
  if (typeof params === "undefined") return "You forgot to set the timer";
  return params > 0 ? "Not done, please wait." : "Lasagna is done.";
}
console.log(cookingStatus(12));
// => 'Not done, please wait.'
console.log(cookingStatus(undefined));
console.log(cookingStatus());
console.log(cookingStatus(0));
// => 'You forgot to set the timer.'

// Task 2:Estimate the preparation tim
const layers = ["sauce", "noodles", "sauce", "meat", "mozzarella", "noodles"];
...
console.log(myList, friendsList);
// => ['noodles', 'meat', 'sauce', 'mozzarella', 'kampot pepper']
